...
Le tipologie di comunicazione adottate nel contesto di un'architettura a microservizi si scandiscono in base a due criteri di selezione \cite[p.19]{Thesis_microservices}:
\begin{itemize}
